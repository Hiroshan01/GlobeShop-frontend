...
export default function SearchProductPage() {
    ...
    const fetchAllProducts = useCallback(() => {
        ...
        const endpoint = debouncedQuery.trim()
            ? `${import.meta.env.VITE_BACKEND_URL}/api/product/search/${encodeURIComponent(debouncedQuery)}`
        ...
        buttons.push(
            <button
                ...
                className={`px-4 py-2 mx-1 rounded-lg font-medium transition-all ${currentPage === 1
                    ...
                    : 'bg-gradient-to-r from-purple-400 to-blue-400 hover:shadow-md text-white'
                    }`}
            >
                Previous
            </button>
            ...
            buttons.push(
                <button
                    ...
                    className={`px-3 py-2 mx-1 rounded-lg font-medium transition-all ${i === currentPage
                        ? 'bg-gradient-to-r from-purple-400 to-blue-400 shadow-md text-white'
