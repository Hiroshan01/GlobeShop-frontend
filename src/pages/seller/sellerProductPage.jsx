...
export default function SellerProductPage() {
    ...
    useEffect(() => {
        ...
        if (isLoading) {
            axios
                .get(import.meta.env.VITE_BACKEND_URL + "/api/product/seller", {  // Remove trailing "/" to match backend route
                    headers: {
    ...
    function deleteProduct(productId) {
        ...
        axios.delete(import.meta.env.VITE_BACKEND_URL + "/api/product/seller/" + productId, {
            headers: {
