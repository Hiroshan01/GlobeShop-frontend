...
export default function SellerOrderPage() {
    ...
    const fetchOrders = async () => {
        ...
        try {
            const response = await axios.get(import.meta.env.VITE_BACKEND_URL + "/api/order/seller", {
                headers: {
    ...
    const updateOrderStatus = async (orderId, newStatus) => {
        ...
        try {
            await axios.put(
                `${import.meta.env.VITE_BACKEND_URL}/api/order/seller/${orderId}/${newStatus}`,
                {},
                {
                    headers: {
                        Authorization: "Bearer " + token,
                    ...
                    <div>
                        ...
                        <div className="space-y-2">
                            ...
                            <p>
                                ...
                                <span
                                    className={`font-bold ${selectedOrder.status === "pending"
                                        ? "text-yellow-500"
